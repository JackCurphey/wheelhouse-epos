...
replaced by §1.4 of the same document: the free product is the booking system
and the diary together, as one thing. Landed on `main` as the record of the
reasoning; treat §4 and §5b as historical and everything else as live.
