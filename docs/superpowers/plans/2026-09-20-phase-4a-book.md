...
whole of the customer's first journey. **Decision J1 below.**
...
- **J1 - where the customer screens live.** (1) Under `/workshop` in the staff
...
- **J3 - booking modes.** The same line records three modes: timed,
...
- **J4 - deposits (note 04).** The sources disagree. Out: the scope reduction
