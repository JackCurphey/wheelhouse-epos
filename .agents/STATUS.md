...
**Last verified:** atlas checks green 20 Sep, 82 screens, no errors. `npm test`
and the rest were **not** re-run on 20 Sep; last known 278 pass, 10 Sep. The
docker `app` image is from 31 Aug — verify the working tree, not that container.
