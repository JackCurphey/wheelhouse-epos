...
let fullDays = []; // {mechanicId, jobDate} - days the server's capacity calculator finds no free time left in (after blocks, jobs and the reserve), treated like a closed day
let bikes = [];
let bookings = [];
